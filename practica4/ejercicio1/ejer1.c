/* Practica 4
	Ejercicio 4.1
		...
		generales en vez de semáforos binarios y variables de condición. Haga su programa genérico para	
		que se pueda indicar el tamaño del buffer y la cantidad de datos a producir-consumir
