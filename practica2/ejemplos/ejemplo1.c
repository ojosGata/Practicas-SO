...
int main(){
	...
	/* Creamos dos hilos. La función la pasaremos como (void *) nombreFuncion. Es decir, hacemos un	casting
	a	(void *),aunque por defecto no es necesario, ya que el nombre de una función es su dirección de memoria. También es importante realizar esto con la dirección de memoria de la variable que contiene los parámetros que se le pasan a la función */
